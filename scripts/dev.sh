...
# Xevon AI Monorepo Development Environment Setup Script
# This script starts all necessary services for the full-stack development
...
start_dev_servers() {
    ...
    print_status "Starting Next.js web app and NestJS server..."
    print_status "Web app will be available at: http://localhost:3000"
    print_status "API server will be available at: http://localhost:3001"
    
    # Start both development servers using turbo in parallel
    bun run dev:apps
}
...
# Main execution
main() {
    print_header "Xevon AI Monorepo Development Environment"
